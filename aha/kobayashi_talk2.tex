...
\begin{frame}{Example}{}
  ...
  \end{proof}
\end{frame}
% \begin{frame}{Question left una}
%   \begin{itemize}
%     \item Why should I \emph{expect} the formula to look like this?
%   \end{itemize}
% \end{frame}
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \includegraphics[keepaspectratio,width=.5\linewidth]{eek.png}
